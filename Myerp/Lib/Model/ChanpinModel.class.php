...
class ChanpinModel extends RelationModel {
   ...
   // 自动验证设置
	...
	protected $_link = array(
		...
		'baozhangzituanlist'=>array('mapping_type'=>BELONGS_TO,'class_name'=>'Zituan','true_class_name'=>'myerpview_chanpin_zituan','foreign_key'=>'parentID','parent_key'=>'chanpinID'),//class_name写,true_class_name读
		//baozhangitem
