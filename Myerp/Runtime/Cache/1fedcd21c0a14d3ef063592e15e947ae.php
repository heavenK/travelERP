<?php if (!defined('THINK_PATH')) exit();?>
    ...
    <div id="mysearchdiv" style="margin-bottom:10px;">
      <ul id="searchTabs" class="tablist tablist_2">
        <li> <a <?php if($nowDir['title'] == '基本信息'){ ?> class="current" <?php } ?> href="javascript:ajaxalert('请先创建基本信息')">基本信息</a> </li>
        <li> <a <?php if($nowDir['title'] == '行程'){ ?> class="current" <?php } ?> href="javascript:ajaxalert('请先创建基本信息')">&nbsp;&nbsp;行&nbsp;&nbsp;程&nbsp;&nbsp;</a> </li>
        <li> <a <?php if($nowDir['title'] == '成本售价'){ ?> class="current" <?php } ?> href="javascript:ajaxalert('请先创建基本信息')">成本售价</a> </li>
      </ul>
    </div>
    <?php } ?>
