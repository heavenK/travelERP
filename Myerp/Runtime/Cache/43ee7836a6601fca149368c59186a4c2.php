            ...
            <table cellpadding="1" cellspacing="0" width="100%" class="list view">
              <tbody>
                ...
                <tr height="20">
                  ...
                  <th scope="col" nowrap="nowrap" style="min-width:80px;"><div> 名额 </div></th>
                ...
                <tr height="30" class="evenListRowS1" id="zituandiv<?php echo ($v['chanpinID']); ?>">
                    ...
                    <input class="button" type="button" value="删除" onClick="deletezituan(<?php echo ($v['chanpinID']); ?>,<?php echo ($v['parentID']); ?>)" />
