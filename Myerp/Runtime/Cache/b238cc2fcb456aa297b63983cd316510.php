...
<div id="main">
  <div id="content" style="margin-left:0;">
    ...
    <table class="other view">
      <tbody>
        <tr>
          <td width="20%" scope="row"><img border="0" width="16" height="16" align="absmiddle" src="<?php echo __PUBLIC__;?>/myerp/images/Administration.gif">&nbsp;<a href="<?php echo SITE_INDEX;?>SetSystem/">数据开放权限查询</a></td>
          <td width="30%">数据开放权限查询</td>
        </tr>
      </tbody>
    </table>
      <?php } ?>
