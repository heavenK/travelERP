...
function showmysearchdiv(s)
{
	...
	function sendValue(){
		...
		window.parent.document.getElementById("tupian").value=str;
		window.parent.document.getElementById("Images_id").value=ids;
