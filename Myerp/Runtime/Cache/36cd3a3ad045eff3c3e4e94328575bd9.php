<?php if (!defined('THINK_PATH')) exit();?>        <style>
  ...
  <div id="leftColumn" style="margin-top:7px; width:150px;">
        <ul id="searchTabs" class="tablist tablist_2">
          ...
          <li><a id="shownavtab_2" href="javascript:void(0)" onclick="shownavtab(2)">&nbsp;在线&nbsp;</a></li>
        ...
        <div id="navtab_1" class="leftList">
          ...
          <ul id="ul_shortcuts">
            ...
            <li> <a href="<?php echo SITE_INDEX;?>Dijie/index/status/准备/guojing/境外/kind/日本">&nbsp;<span>台湾来团</span></a> </li>
          </ul>
        </div>
        ...
        <div id="navtab_2" class="leftList" style="display:none;">
          ...
          <ul id="ul_shortcuts">
            ...
            <li> <a href="<?php echo SITE_INDEX;?>Dijie/index/status/在线/guojing/境外/kind/日本">&nbsp;<span>台湾来团</span></a> </li>
          </ul>
        </div>
        ...
        <div id="navtab_3" class="leftList" style="display:none; color:black">
          ...
          <ul id="ul_shortcuts">
            ...
            <li> <a href="<?php echo SITE_INDEX;?>Dijie/index/status/截止/guojing/境外/kind/日本">&nbsp;<span>台湾来团</span></a> </li>
          </ul>
        </div>
