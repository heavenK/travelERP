    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="list view">
      <tbody>
        ...
        <tr height="20">
          ...
          <th scope="col" nowrap="nowrap"><div> 负责人 </div></th>
          <th scope="col" nowrap="nowrap"><div> 接团时间 </div></th>
      ...
      <tr height="30" class="evenListRowS1">
        ...
        <td scope="row" align="left" valign="top" style="min-width:200px; width:20%"><a href="<?php echo SITE_INDEX;?>Dijie/fabu/chanpinID/<?php echo ($v['chanpinID']); ?>"><?php echo ($v['title']); ?></a></td>
        <td scope="row" align="left" valign="top"><?php echo ($v['tuanhao']); ?></td>
        <td scope="row" align="left" valign="top"><?php echo ($v['onperson']); ?></td>
        <td scope="row" align="left" valign="top"><?php echo ($v['jietuantime']); ?></td>
        <td scope="row" align="left" valign="top"><?php echo ($v['user_name']); ?></td>
        <td scope="row" align="left" valign="top" style="min-width:120px;"><?php echo ($v['bumen_copy']); ?></td>
