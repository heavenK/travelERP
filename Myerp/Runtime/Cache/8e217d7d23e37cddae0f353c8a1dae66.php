...
$(function() {
      ...
      <input type="submit" class="button" value="查找"></form><br><div id="unified_search_advanced_div"></div></div><div id="sitemapLink"><span id="sitemapLinkSpan"> 站点地图 <img src="<?php echo __PUBLIC__;?>/myerp/images/MoreDetail.png"></span></div><span id="sm_holder"></span><div class="clear"></div><div id="moduleList"><ul><li class="noBorder">&nbsp;</li><li><span class="currentTabLeft">&nbsp;</span><span class="currentTab"><a href="#" id="grouptab_0">&nbsp;旅游产品&nbsp;</a></span><span class="currentTabRight">&nbsp;</span></li><li><span class="notCurrentTabLeft">&nbsp;</span><span class="notCurrentTab"><a href="#" id="grouptab_1">&nbsp;财务管理&nbsp;</a></span><span class="notCurrentTabRight">&nbsp;</span></li><li><span class="notCurrentTabLeft">&nbsp;</span><span class="notCurrentTab"><a href="#" id="grouptab_2">&nbsp;系统管理&nbsp;</a></span><span class="notCurrentTabRight">&nbsp;</span></li><li><span class="notCurrentTabLeft">&nbsp;</span><span class="notCurrentTab"><a href="#" id="grouptab_3">&nbsp;销售&nbsp;</a></span><span class="notCurrentTabRight">&nbsp;</span></li><li><span class="notCurrentTabLeft">&nbsp;</span><span class="notCurrentTab"><a href="#" id="grouptab_4">&nbsp;信息&nbsp;</a></span><span class="notCurrentTabRight">&nbsp;</span></li></ul></div><div class="clear"></div><div id="subModuleList"><span id="moduleLink_0"  class="selected"><ul><li><a href="#">发布产品</a></li><li><a href="#">产品审核</a></li><li><a href="#">产品控管</a></li><li><a href="#">订单控管</a></li><li><a href="#">客户管理</a></li><li><a href="#">数据字典</a></li><li><a href="#">统计</a></li></ul></span><span id="moduleLink_1"><ul><li><a href="#">报表项审核</a></li><li><a href="#">报表审核管理</a></li><li><a href="#">签证</a></li><li><a href="#">单项服务</a></li><li><a href="#">统计</a></li></ul></span><span id="moduleLink_2"><ul><li><a href="#">用户</a></li><li><a href="#">系统工具</a></li><li><a href="#">系统设置</a></li><li><a href="#">站内信息</a></li><li><a href="#">产品平移</a></li></ul></span><span id="moduleLink_3"><ul><li><a href="#">线路产品</a></li><li><a href="#">机票</a></li><li><a href="#">酒店</a></li><li><a href="#">门票</a></li></ul></span><span id="moduleLink_4"><ul><li><a href="#">公告</a></li><li><a href="#">排团表</a></li><li><a href="#">系统提示</a></li></ul></span></div><div class="clear"></div><div class="line"></div><div id="lastView" class="headerList"><b style="white-space:nowrap;">最近查看:&nbsp;&nbsp;</b><span> 无 </span></div></div><div id="main"><div id="leftColumn" style="margin-top:7px; width:148px;"><ul id="searchTabs" class="tablist tablist_2"><li style="margin-right:1px;"><a id="shownavtab_1" class="current" href="javascript:selectTabCSS('Calls|basic_search');" onmouseover="shownavtab(1)">&nbsp;准备&nbsp;</a></li><li style="margin-right:1px;"><a id="shownavtab_2" href="javascript:selectTabCSS('Calls|advanced_search');" onmouseover="shownavtab(2)">&nbsp;报名&nbsp;</a></li><li><a id="shownavtab_3" href="javascript:selectTabCSS('Calls|advanced_search');" onmouseover="shownavtab(3)">&nbsp;截止&nbsp;</a></li></ul><style>		#ul_shortcuts li a{ color:blue; color:#0B578F}
		#ul_shortcuts li a:hover{ color:black;}
		</style><div id="navtab_1" class="leftList"><h3 style=" text-align:center; border:none">准备中的产品</h3><h3><span>国内/拼团</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li></ul><h3><span>国内/散客</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li><li><a href="#">&nbsp;<span>|---我爱中华</span></a></li><li><a href="#">&nbsp;<span>|---自由人</span></a></li><li><a href="#">&nbsp;<span>|---印象之旅</span></a></li><li><a href="#">&nbsp;<span>|---爱之旅</span></a></li><li><a href="#">&nbsp;<span>|---夏之旅</span></a></li><li><a href="#">&nbsp;<span>|---成都海悦</span></a></li><li><a href="#">&nbsp;<span>|---通话假期</span></a></li><li><a href="#">&nbsp;<span>|---西部国旅</span></a></li></ul><h3><span>国内</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li><li><a href="#">&nbsp;<span>机票</span></a></li><li><a href="#">&nbsp;<span>酒店</span></a></li></ul><h3><span>境外</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>海岛游</span></a></li><li><a href="#">&nbsp;<span>出境游</span></a></li><li><a href="#">&nbsp;<span>欧美澳非</span></a></li><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li></ul></div><div id="navtab_2" class="leftList" style="display:none"><h3 style=" text-align:center; border:none">报名中的产品</h3><h3><span>国内/拼团</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li></ul><h3><span>国内/散客</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li><li><a href="#">&nbsp;<span>|---我爱中华</span></a></li><li><a href="#">&nbsp;<span>|---自由人</span></a></li><li><a href="#">&nbsp;<span>|---印象之旅</span></a></li><li><a href="#">&nbsp;<span>|---爱之旅</span></a></li><li><a href="#">&nbsp;<span>|---夏之旅</span></a></li><li><a href="#">&nbsp;<span>|---成都海悦</span></a></li><li><a href="#">&nbsp;<span>|---通话假期</span></a></li><li><a href="#">&nbsp;<span>|---西部国旅</span></a></li></ul><h3><span>国内</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li><li><a href="#">&nbsp;<span>机票</span></a></li><li><a href="#">&nbsp;<span>酒店</span></a></li></ul><h3><span>境外</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>海岛游</span></a></li><li><a href="#">&nbsp;<span>出境游</span></a></li><li><a href="#">&nbsp;<span>欧美澳非</span></a></li><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li></ul></div><div id="navtab_3" class="leftList" style="display:none"><h3 style=" text-align:center; border:none">已截止的产品</h3><h3><span>国内/拼团</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li></ul><h3><span>国内/散客</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>近郊游</span></a></li><li><a href="#">&nbsp;<span>长线游</span></a></li><li><a href="#">&nbsp;<span>|---我爱中华</span></a></li><li><a href="#">&nbsp;<span>|---自由人</span></a></li><li><a href="#">&nbsp;<span>|---印象之旅</span></a></li><li><a href="#">&nbsp;<span>|---爱之旅</span></a></li><li><a href="#">&nbsp;<span>|---夏之旅</span></a></li><li><a href="#">&nbsp;<span>|---成都海悦</span></a></li><li><a href="#">&nbsp;<span>|---通话假期</span></a></li><li><a href="#">&nbsp;<span>|---西部国旅</span></a></li></ul><h3><span>国内</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li><li><a href="#">&nbsp;<span>机票</span></a></li><li><a href="#">&nbsp;<span>酒店</span></a></li></ul><h3><span>境外</span></h3><ul id="ul_shortcuts"><li><a href="#">&nbsp;<span>海岛游</span></a></li><li><a href="#">&nbsp;<span>出境游</span></a></li><li><a href="#">&nbsp;<span>欧美澳非</span></a></li><li><a href="#">&nbsp;<span>自由人</span></a></li><li><a href="#">&nbsp;<span>包团</span></a></li></ul></div></div><style>.moduleTitle {
    background-image: url("<?php echo __PUBLIC__;?>/myerp/images/index.php.gif");
    background-color: #FFFFFF;
    background-position: center top;
    background-repeat: repeat-x;
    vertical-align: middle;
}
</style><div id="content" style="margin-left:170px;"><table><tbody><tr><td><div ><div class="moduleTitle" style="margin-bottom:10px;"><h2 style="margin-top:10px;">旅游产品：产品发布</h2><div style="float:left; margin-left:50px; margin-top:6px;"><span style="display: none;" id="show_link_insideview"><a href="javascript:void(0);" onclick="showmysearchdiv(1)"><img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/insideview_collapsed.png"></a></span><span style="" id="hide_link_insideview"><a href="javascript:void(0);" onclick="showmysearchdiv(2)"><img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/insideview_expanded.png"></a></span></div><span style="margin-top:10px;"><img src="<?php echo __PUBLIC__;?>/myerp/images/help.gif" alt="帮助"></a><a href="javascript:void(0)" onclick="alert('暂无');" class="utilsLink" target="_blank"> 帮助 </a></span></div><div id="mysearchdiv"><ul id="searchTabs" class="tablist"><li style="margin-right:1px;"><a id="searchtab_1" class="current" href="javascript:selectTabCSS('Calls|basic_search');" onclick="showsearch(1)">基本查找</a></li><li><a id="searchtab_2" href="javascript:selectTabCSS('Calls|advanced_search');" onclick="showsearch(2)">高级查找</a></li></ul><div class="search_form" id="searchdiv_1" style="margin-bottom:0px;"><div class="edit view search "><table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody><tr><td scope="row" nowrap="nowrap"> 名称 </td><td nowrap="nowrap"><input type="text" name="title" id="title"></td><td scope="row" nowrap="nowrap"> 编号 </td><td nowrap="nowrap"><input type="text" name="bianhao" id="bianhao"></td><td scope="row" nowrap="nowrap"> 团期 </td><td nowrap="nowrap"><input type="text" onfocus="WdatePicker()" id="chufariqi" name="chufariqi" value="<?php echo ($chufariqi); ?>" ></tbody></table></div><input tabindex="2" title="查找" class="button" type="button" value=" 查找 " onclick="dosearch();">&nbsp;
