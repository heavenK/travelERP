<?php if (!defined('THINK_PATH')) exit();?><?php A("Index")->showheader(); ?><script type="text/javascript" src="<?php echo __PUBLIC__;?>/myerp/ckeditor/ckeditor.js"></script><script type="text/javascript" src="<?php echo __PUBLIC__;?>/myerp/ckfinder/ckfinder.js"></script><div id="main"><?php A("Chanpin")->left_fabu(); ?><div id="content" style="margin-left:170px;"><script type="text/javascript">    var SITE_INDEX = '<?php echo SITE_INDEX;?>';
	...
	.cke_icon{ border: 1px solid #94C1E8;}
          ...
          CKFinder.setupCKEditor( editor, '<?php echo __PUBLIC__;?>/gulianstyle/ckfinder/' ) ;
          </script></td></tr></tbody></table><div class="buttons"><input type="submit" value="保存" name="button" class="button primary"><input type="button" value="取消" name="button" class="button"></div></form></div></div><?php A("Index")->footer(); ?><script>jQuery(document).ready(function(){
	  pid = jQuery('#pos2').val();
	  change_jingshe(pid);
...
function doshenhe(){
	...
	jQuery.ajax({
		...
		data:	"dataID="+dataID+"&dotype=提交审核&processID=1"+"&datatype="+datatype,
		success:function(msg){
