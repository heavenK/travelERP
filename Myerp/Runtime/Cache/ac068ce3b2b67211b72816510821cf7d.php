...
<form name="form" method="post" id="form">
  <?php if($xianlu[chanpinID]){ ?>
  <input name="chanpinID" id="chanpinID" type="hidden" value="<?php echo ($xianlu['chanpinID']); ?>" >
  <?php }else{ ?>
  <input name="guojing" type="hidden" id="guojing" value="<?php echo ($guojing); ?>" >
  <input name="kind" type="hidden" id="kind" value="<?php echo ($kind); ?>" >
  <input name="xianlutype" id="xianlutype" type="hidden" value="<?php echo ($xianlutype); ?>">
  <?php } ?>
  ...
  <input type="hidden" name="ajax" value="1"> <!--ajax提示-->
    ...
    <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
      <tbody>
        ...
        <tr>
          ...
          <td valign="top" scope="row" style="min-width:400px;"><input name="title" type="text" id="title" value="<?php echo trim($xianlu['title']) ?>" style="width:98%;" check="^\S+$" warning="账号不能为空,且不能含有空格" ></td>
          <td valign="top" scope="row"> 报名截止: </td>
          <td valign="top" scope="row" style="min-width:300px;"><span>出团前</span><input style="width:50px; margin:0 4px 0 4px;" name="baomingjiezhi" type="text" value="<?php if ($xianlu['baomingjiezhi']) echo $xianlu['baomingjiezhi']; else echo 1 ?>" id="baomingjiezhi" ><span>天</span></td>
        </tr>
        <tr>
          <td valign="top" scope="row" style="min-width:100px;"> 始发地: </td>
          <td valign="top">
            <select name="chufashengfen_id" id="chufashengfen_id" onchange="change_pos_go()" class="button">
            ...
            <input type="hidden" name="chufachengshi" id="chufachengshi"/>
          </td>
          <td valign="top" scope="row" style="min-width:100px;"> 目的地: </td>
          <td valign="top">
                <select name="guojing" id="guojing" class="button">
                ...
                <input type="hidden" name="chengshi" id="pos_name3"/>
          </td>
        </tr>
        <tr>
          <td valign="top" scope="row"> 计划人数: </td>
          <td valign="top">
          <input type="text" id="renshu" name="renshu" style="width:50px; margin:0 4px 0 4px;" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" value="<?php echo ($xianlu['renshu']); ?>" ><span style=" margin:0 10px 0 4px">人</span>
          <input id="ischild" type="checkbox" name="ischild" value="1" <?php if($xianlu[ischild] == 1){ ?> checked="checked"<?php } ?> ><label style=" margin:0 4px 0 4px">儿童不占位</label>
          </td>
          <td valign="top" scope="row"> 行程天数: </td>
          <td valign="top"><input type="text" id="tianshu" name="tianshu" style="width:50px; margin:0 4px 0 4px;" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" value="<?php echo ($xianlu['tianshu']); ?>"><span>天</span></td>
        </tr>
      </tbody>
    </table>
                ...
                <fieldset style="border:#CBDAE6 1px solid">
                  ...
                  <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit">
                    <tbody>
                      <tr>
                        <td>
                        <textarea style="width:100%; resize:none" rows="3" readonly name="chutuanriqi" id="chutuanriqi" onclick="setdate(this.id);"><?php echo ($xianlu['chutuanriqi']); ?></textarea>
                        </td>
                        <td>
                        <span class="id-ff multiple" style="margin:0 0 0 10px;">
                        <button style="margin: 0 0 2px 4px;" id="bt_showdate" class="button firstChild" type="button" onclick="setdate('chutuanriqi');"><img src="<?php echo __PUBLIC__;?>/myerp/images/id-ff-select.png"></button>
                        <button style="margin: 0 0 2px 4px;" onclick="clearinput('chutuanriqi');" class="button lastChild" type="button"><img src="<?php echo __PUBLIC__;?>/myerp/images/id-ff-clear.png"></button>
                        </span>
                        </td>
                      </tr>
                    </tbody>
        ...
        <tr>
          ...
          <td valign="top">
            ...
            <select name="zhuti" id="zhuti">
              <?php if($xianlu['zhuti']){ ?>
              <option value="<?php echo ($xianlu['zhuti']); ?>"><?php echo ($xianlu['zhuti']); ?></option>
              <?php }else{ ?>
              <option value="">请选择...</option>
              <?php } ?>
              <?php foreach($xianlu['theme_all'] as $theme){ ?>
            ...
            <input type="button" id="submitTheme" onclick="submit_theme()" value="确定" style="display:none;margin: 0 0 2px 4px;" />

          </td>
          <td valign="top" scope="row" style="min-width:100px;"> 导游服务: </td>
          <td valign="top">
            <?php if($xianlu['quanpei']){ ?>
            ...
            <?php } ?>
            <label style=" margin:0 4px 0 4px">地陪</label>
          </td>
        </tr>
        <tr>
          <td valign="top" scope="row"> 视频: </td>
          <td valign="top">
            <input readonly name="shipin" type="text" id="shipin" value="<?php echo ($xianlu['shipin']); ?>" onclick="showdiv_2('shipin')" style="width:200px;">
            <input type="hidden" id="Videos_id" />
            <input type="button" value="选择" class="button" style="margin: 0 0 2px 4px;" onclick="showdiv_2('shipin')" id="selectshipin"/>
          </td>
          <td valign="top" scope="row"> 图片: </td>
          <td valign="top">
            <input readonly name="tupian" type="text" id="tupian" value="<?php echo ($xianlu['tupian']); ?>" onclick="showdiv_2('tupian')" style="width:200px;">
            ...
            <input type="button" value="清空" class="button" style="margin: 0 0 2px 4px;" onclick="clearinput('tupian')" id="selecttupian"/>
          </td>
        </tr>
      </tbody>
    </table>
    ...
    <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view" style=" border-top-color: #CBDAE6 !important;">
      <tbody>
        ...
        <tr>
          ...
          <textarea name="xingchengtese" id="xingchengtese"><?php echo ($xianlu['xingchengtese']); ?></textarea>
		  <script type="text/javascript">
        ...
        <tr>
          ...
          <td valign="top" colspan="3">
          <textarea name="cantuanxuzhi" id="cantuanxuzhi"><?php echo ($xianlu['cantuanxuzhi']); ?></textarea>
		  <script type="text/javascript">
    ...
    <div class="buttons">
      <input type="submit" value="保存" name="button" class="button primary">
      <input type="button" value="取消" name="button" class="button">
    </div>
...
jQuery(document).ready(function(){
	//目的地
	  jQuery.ajax({
		  type:	"POST",
		  url:	"<?php echo SITE_INDEX;?>Message/liandong",
		  async: false,
		  data:	"type=地区",
...
//	ThinkAjax.sendForm('form','<?php echo SITE_INDEX;?>SetSystem/postDataDictionay/',doComplete_11,'resultdiv');
	
	jQuery.ajax({
		type:	"POST",
		url:	"<?php echo SITE_INDEX;?>SetSystem/dopostSystemHas/tableName/datadictionary/type/主题",
...
function showdiv_2(id){
   ...
   if(id == 'shipin'){
		var url = '<?php echo SITE_INDEX;?>/SetSystem/dataDictionary/type/视频';
   ...
   if(id == 'tupian'){
		var url = '<?php echo SITE_INDEX;?>/SetSystem/dataDictionary/type/图片';
...
function doComplete(data,status){
	if(status == 1){
		...
		if (chanpinID)
			...
			window.location.href='<?php echo SITE_INDEX;?>Chanpin/zituan/chanpinID/'+chanpinID;
	}
}
...
<div style="position: absolute; display:none;" id="divselect">
  <table cellspacing="0" cellpadding="1" border="0" class="olBgClass">
    <tbody>
      <tr>
        <td>
        <table cellspacing="0" cellpadding="0" border="0" width="100%" class="olCgClass">
            <tbody>
              <tr>
                <td width="100%" class="olCgClass">
                    <div style="float:left" id="iftitle"></div>
                    <div style="float: right">
                    <a title="关闭" href="javascript:void(0);" onClick="javascript:return div_close('divselect');">
                    <img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/close.gif" style="margin-left:2px; margin-right: 2px;">
                    </a>
                    </div>
                </td>
              </tr>
          ...
          <table cellspacing="0" cellpadding="0" border="0" width="100%" class="olFgClass">
            <tbody>
              <tr>
                <td valign="top" class="olFgClass">
                    <iframe id="iframeselect" frameborder="0" width="700px" height="400px" scrolling="auto" ></iframe>
                </td>
              </tr>
            </tbody>
          </table>
      ...
      <tr>
        <td><table cellspacing="0" cellpadding="0" border="0" width="100%" class="olCgClass">
            <tbody>
              <tr>
                <td width="100%" class="olCgClass">
                    <div style="float:left">选择出团日期</div>
                    <div style="float: right">
                    <a title="关闭" href="javascript:void(0);" onClick="javascript:return div_close('datediv');">
                    <img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/close.gif" style="margin-left:2px; margin-right: 2px;">
                    </a>
                    </div>
                </td>
          ...
          <table cellspacing="0" cellpadding="0" border="0" width="100%" class="olFgClass">
            <tbody>
              <tr>
                <td valign="top" class="olFgClass">
                    <iframe id="dateiframe" frameborder="0" scrolling="no" width="390px" height="180px" style="margin-top:4px;"></iframe>
                </td>
              </tr>
            </tbody>
          </table></td>
