      ...
      <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view">
        <tbody>
          ...
          <tr>
            ...
            <td valign="top"><input type="text" id="renshu" name="renshu" style="width:50px; margin:0 4px 0 4px;" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" value="<?php echo ($xianlu['renshu']); ?>"  check="^\S+$" warning="计划人数不能为空,且不能含有空格" >
            ...
            <td valign="top"><input type="text" id="tianshu" name="tianshu" style="width:50px; margin:0 4px 0 4px;" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" value="<?php echo ($xianlu['tianshu']); ?>" check="^\S+$" warning="行程天数不能为空,且不能含有空格" >
              <span>天</span></td>
          </tr>
        </tbody>
      </table>
          ...
          <tr>
            <td valign="top"><fieldset style="border:#CBDAE6 1px solid">
                ...
                <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit">
                  <tbody>
                    <tr>
                      <td><textarea style="width:100%; resize:none" rows="3" readonly name="chutuanriqi" id="chutuanriqi" onclick="setdate(this.id);"  check="^\S+$" warning="出团日期不能为空,且不能含有空格" ><?php echo ($xianlu['chutuanriqi']); ?></textarea></td>
      ...
      <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view" style=" border-top-color: #CBDAE6 !important;">
        <tbody>
          ...
          <tr>
            ...
            <td valign="top"><?php if($xianlu['quanpei']){ ?>
          ...
          <tr>
            ...
            <td valign="top"><input readonly name="shipin" type="text" id="shipin" value="<?php echo ($xianlu['shipin']); ?>" onclick="showdiv_2('shipin')" style="width:200px;">
            ...
            <td valign="top"><input readonly name="tupian" type="text" id="tupian" value="<?php echo ($xianlu['tupian']); ?>" onclick="showdiv_2('tupian')" style="width:200px;">
      ...
      <table cellspacing="1" cellpadding="0" border="0" width="100%" class="edit view" style=" border-top-color: #CBDAE6 !important;">
        <tbody>
          ...
          <tr>
            ...
            <td valign="top" colspan="3"><textarea name="xingchengtese" id="xingchengtese"><?php echo ($xianlu['xingchengtese']); ?></textarea>
          ...
          <tr>
            ...
            <td valign="top" colspan="3"><textarea name="cantuanxuzhi" id="cantuanxuzhi"><?php echo ($xianlu['cantuanxuzhi']); ?></textarea>
              <script type="text/javascript">
...
function doComplete(data,status){
	if(status == 1){
			window.location.href='<?php echo SITE_INDEX;?>Chanpin/fabu/chanpinID/'+data['chanpinID'];
	}
}
            ...
            <tbody>
              <tr>
                <td width="100%" class="olCgClass"><div style="float:left" id="iftitle"></div>
                  <div style="float: right"> <a title="关闭" href="javascript:void(0);" onClick="javascript:return div_close('divselect');"> <img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/close.gif" style="margin-left:2px; margin-right: 2px;"> </a> </div></td>
              </tr>
            </tbody>
          </table>
            ...
            <tbody>
              <tr>
                <td width="100%" class="olCgClass"><div style="float:left">选择出团日期</div>
                  <div style="float: right"> <a title="关闭" href="javascript:void(0);" onClick="javascript:return div_close('datediv');"> <img border="0" src="<?php echo __PUBLIC__;?>/myerp/images/close.gif" style="margin-left:2px; margin-right: 2px;"> </a> </div></td>
              </tr>
            </tbody>
          </table>
          <table cellspacing="0" cellpadding="0" border="0" width="100%" class="olFgClass">
