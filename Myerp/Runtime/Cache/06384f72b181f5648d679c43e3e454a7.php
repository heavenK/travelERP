            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="list view">
              ...
              <?php $i=0;foreach($datalist as $v){ $i++; ?>
                <tr height="30" class="evenListRowS1">
                  <td scope="row" align="left" valign="top"><input <?php if(in_array($v['title'],$tupianlist)){ ?> checked="checked"<?php } ?> id="<?php echo ($v[systemID]); ?>" type="checkbox" name="checkboxs" value="<?php echo ($v[title]); ?>"></td>
