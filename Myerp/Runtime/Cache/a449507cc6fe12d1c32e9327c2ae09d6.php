          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="list view" id="chengben">
            <tbody>
                    ...
                    <tbody>
                      <tr>
                        <td nowrap="nowrap" class="paginationActionButtons">
                          <strong>成本项目</strong>&nbsp;
                          <input class="button" type="button" value="新增" onclick="insertchengben();" />
                        </td>
                      </tr>
                    </tbody>
                  </table>
              ...
              <tr height="30" class="evenListRowS1" id="chengbenrow<?php echo ($v['chanpinID']); ?>">
                ...
                <td scope="row" align="left" valign="top">
                <select name="title" id="title<?php echo ($v['chanpinID']); ?>" >
                <?php if($v['title']){ ?>
                ...
                <td scope="row" align="left" valign="top">
				<input type="text" name="title" id="title<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['title']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
				<input type="text" name="price" id="price<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['price']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <select name="jifeitype" id="jifeitype<?php echo ($v['chanpinID']); ?>" >
                <?php if($v['jifeitype']){ ?>
                ...
                <td scope="row" align="left" valign="top">
                <input class="button" type="button" value="删除" onClick="deletechengben(<?php echo ($v['chanpinID']); ?>)" />
                <input class="button" type="button" value="修改" onClick="addchengben(<?php echo ($v['chanpinID']); ?>)" />
                </td>
              </tr>
              <?php } ?>
                    ...
                    <tbody>
                      <tr>
                        <td nowrap="nowrap">
                          ...
                          <input style="margin-top:-2px;" class="button" type="button" value="保存" onclick="saveshoujia()"/>
                        </td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" class="list view" id="shoujia">
            <tbody>
                    ...
                    <tbody>
                      <tr>
                        <td nowrap="nowrap" class="paginationActionButtons">
                          ...
                          <input class="button" type="button" value="+部门" onclick="insertshoujia('部门');" />
                        </td>
              ...
              <tr height="30" class="evenListRowS1" id="shoujiarow<?php echo ($v['chanpinID']); ?>">
                ...
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="title" id="<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['title']); ?>" >
                <input type="hidden" id="openID<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['openID']); ?>">
                </td>
                <td scope="row" align="left" valign="top">
                <?php echo ($v['opentype']); ?>
                </td>
                <td scope="row" align="left" valign="top">
                <select name="type" id="type<?php echo ($v['chanpinID']); ?>" >
                <?php if($v['type']){ ?>
                ...
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="adultprice" id="adultprice<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['adultprice']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="childprice" id="childprice<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['childprice']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="chengben" id="chengben<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['chengben']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="cut" id="cut<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['cut']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <input style="width:80px;" type="text" name="renshu" id="renshu<?php echo ($v['chanpinID']); ?>" value="<?php echo ($v['renshu']); ?>" >
                </td>
                <td scope="row" align="left" valign="top">
                <input class="button" type="button" value="删除" onClick="deleteshoujia(<?php echo ($v['chanpinID']); ?>)" />
                <input class="button" type="button" value="修改" onClick="if(checktitle(<?php echo ($v['chanpinID']); ?>,'<?php echo ($v['opentype']); ?>'))addshoujia(<?php echo ($v['chanpinID']); ?>,'<?php echo ($v['opentype']); ?>')" />
                </td>
              </tr>
              <?php } ?>
            </tbody>
