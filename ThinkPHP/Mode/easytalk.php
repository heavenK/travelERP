...
return array(
    ...
    THINK_PATH.'/Mode/Easytalk/App.class.php',   // 应用程序类
    THINK_PATH.'/Mode/Easytalk/Action.class.php', // 控制器类
    THINK_PATH.'/Mode/Easytalk/Dispatcher.class.php',  // url
    THINK_PATH.'/Mode/Easytalk/pluginManager.class.php',
    ...
    THINK_PATH.'/Mode/Mycore/Model.class.php', // 模型类
);
?>