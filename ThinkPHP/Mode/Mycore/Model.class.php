...
class Model extends Think
{
     ...
     * @return mixed
     +----------------------------------------------------------
     */
    public function add_My($data='',$options=array(),$replace=false) {
		$data = F_isdataempty($data,$this);
    ...
    public function save_My($data='',$options=array()) {
		$data = F_isdataempty($data,$this);
     ...
     * @return mixed
     +----------------------------------------------------------
     */
    public function delete_My($options=array()) 
	{
