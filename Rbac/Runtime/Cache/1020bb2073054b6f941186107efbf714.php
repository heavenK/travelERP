...
if (status==1)
{
$('result').innerHTML	=	'<span style="color:blue"><img SRC="__PUBLIC__/rbac/Images/ok.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="" align="absmiddle" > 登录成功！3 秒后跳转～</span>';
$('form1').reset();
...
<tr class="row" ><Th colspan="2" class="tCenter space" ><img src="__PUBLIC__/rbac/Images/preview_f2.png" width="32" height="32" border="0" alt="" align="absmiddle"> ThinkPHP管理系统登录</th></tr>
<tr><td height="5" colspan="2" class="topTd" ></td></tr>
