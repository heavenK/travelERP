 ...
 function insertItem(divname)
 {
    ...
    htmlcontent += "<td scope=\"row\" align=\"left\" valign=\"top\"><input type=\"text\" id=\"addr_t"+i+"\" style=\"width:200px\" ></td>";
 ...
 function save(id,divname,mark)
 {
	...
	jQuery.ajax({
		...
		data:	"title="+title+"&lianxiren="+lianxiren+"&officetel="+officetel+"&postal="+postal+"&addr="+addr+"&fax="+fax+"&email="+email+it,
